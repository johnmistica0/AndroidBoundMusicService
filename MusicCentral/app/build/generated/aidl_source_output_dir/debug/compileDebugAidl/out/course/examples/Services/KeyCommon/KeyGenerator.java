...
public interface KeyGenerator extends android.os.IInterface
{
  ...
  {
    @Override public java.util.List<java.lang.String> getSong() throws android.os.RemoteException
    {
      return null;
    }
    @Override public java.util.List<java.lang.String> getArtist() throws android.os.RemoteException
    {
      return null;
    }
    @Override public java.util.List<java.lang.String> getURL() throws android.os.RemoteException
    {
      return null;
    }
    @Override public android.graphics.Bitmap getImage(int i) throws android.os.RemoteException
    {
      return null;
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements course.examples.Services.KeyCommon.KeyGenerator
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_getSong:
        {
          ...
          java.util.List<java.lang.String> _result = this.getSong();
        ...
        {
          data.enforceInterface(descriptor);
          java.util.List<java.lang.String> _result = this.getArtist();
          reply.writeNoException();
          reply.writeStringList(_result);
          return true;
        }
        ...
        {
          data.enforceInterface(descriptor);
          java.util.List<java.lang.String> _result = this.getURL();
          reply.writeNoException();
          reply.writeStringList(_result);
          return true;
        }
    ...
    private static class Proxy implements course.examples.Services.KeyCommon.KeyGenerator
    {
      ...
      @Override public java.util.List<java.lang.String> getArtist() throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getArtist();
          }
          _reply.readException();
          _result = _reply.createStringArrayList();
        }
      ...
      @Override public android.graphics.Bitmap getImage(int i) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getImage(i);
          }
          _reply.readException();
          if ((0!=_reply.readInt())) {
    ...
    static final int TRANSACTION_getArtist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
    static final int TRANSACTION_getURL = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
    static final int TRANSACTION_getImage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
  ...
  public java.util.List<java.lang.String> getSong() throws android.os.RemoteException;
  public java.util.List<java.lang.String> getArtist() throws android.os.RemoteException;
  public java.util.List<java.lang.String> getURL() throws android.os.RemoteException;
